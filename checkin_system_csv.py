...
CSV_FILE = "checkin.csv"  # CSV file for logging scan data
...
# Function to append QR scan data to CSV file
...
def read_qr_code(frame, detected_codes, last_detected_times):
    ...
    time_gap = 5  # Prevent saving the same QR code within 5 seconds
                ...
                if current_time - last_time > time_gap:
                    ...
                    if frame is not None and frame.size > 0:
                        ...
                        if success:
                            ...
                            log_scan_to_csv(timestamp, text)  # 📝 Save to CSV
                        else:
